...
public class ReportGenerator {
	...
	public void parentReport(String browser, String methodName) {
		...
		parentTest.assignCategory("Advanced Automation Training");
		parentTest.assignCategory("SmokeSuite");
		reporter.addSystemInfo("Author", "Priya");
		reporter.addSystemInfo("User Name", "Automation");
