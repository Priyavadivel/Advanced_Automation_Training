package com.mst.automationtraining.constant;

/**
 * 
 * @author Priya V Created Date: Dec 5,2018 Last modified By: Priya V Purpose of
 *         the class: Constant is used to have the default value which is to be
 *         used in the project.
 *
 */
public class Constant {
	public static final String Form_URL = "http://qadevpro2-azicawc-webforms.cs32.force.com/forms/Webform101_VF";
	public static final String chromeDriver = "C:\\Users\\HemaR\\Downloads\\Chromedriver\\chromedriver.exe";
	public static final String Geckodriver = "C:\\Users\\HemaR\\Downloads\\geckodriver-v0.23.0-win64\\geckodriver.exe";
	public static final String Headlessbrowser = "C:\\Users\\HemaR\\Desktop\\Assessment\\AdvancedAutomation\\Headlessbrowser\\phantomjs.exe";
